...
#define STRING_CONFIG_H_AUTHOR "Foxel" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 300.33 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.45, -1.81, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 98.00 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.58, -0.16, 0.0 } // get these values from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 97 }  // default steps per unit for Kossel (GT2, 20 tooth)
